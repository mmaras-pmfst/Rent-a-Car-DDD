...
namespace RentaCar.Api.Common.Errors
{
    public class RentaCarProblemDetailsFactory :ProblemDetailsFactory
    {
        private readonly ApiBehaviorOptions _options;
        public RentaCarProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
        {
